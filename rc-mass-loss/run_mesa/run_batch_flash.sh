...
#SBATCH --error=flash-%A_%a.err ## %A - filled with jobid
#SBATCH --output=flash-%A_%a.out ## %A - filled with jobid
...
cp -r work_flash "run_flash_${fid}"
...
cp ../final_model/index${index}_rgbtip.mod start.mod
